...
struct line{
	...
	ll alt(ll x, ll y){return a * x + b * y + c;}
	ll alt(P A){return alt(A.x, A.y);}
	ll dis(ll x, ll y){return abs(alt(x, y)) / sqrtl(a * a + b * b);}
	ll dis(P A){return dis(A.x, A.y);}
